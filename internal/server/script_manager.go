...
type ScriptManager struct {
	ScriptPool *api.ScriptPool
	Endpoint   string
}

// NewScriptManager creates a new ScriptManager instance
func NewScriptManager(scPool *api.ScriptPool, endpoint string) *ScriptManager {
...
func SetupScriptsRoutes(router *gin.Engine, manager *ScriptManager) {
